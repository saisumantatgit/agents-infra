...
echo "  1. Make this directory discoverable as a plugin (claude --plugin-dir $SCRIPT_DIR,"
echo "     add to your plugin marketplace, or copy into your Claude Code plugins path)."
echo "  2. The PostToolUse capture hook (hooks/hooks.json) then records"
